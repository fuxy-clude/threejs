...
import basicFragmentShader from './shader/row_shader/fragmentShader.glsl';
import basicVertexShader from './shader/row_shader/vertexShader.glsl';
...
export default function Demo03() {
  ...
  useEffect(() => {
    ...
    const flag = new Three.TextureLoader().load(require('@/assets/ca.jpeg'));
