...
import basicFragmentShader from './shader/basicShader/fragmentShader.glsl';
import basicVertexShader from './shader/basicShader/vertexShader.glsl';
...
export default function Demo03() {
  ...
  useEffect(() => {
    ...
    const newPlaneGeometry = new Three.PlaneGeometry(20, 20, 20, 20);
